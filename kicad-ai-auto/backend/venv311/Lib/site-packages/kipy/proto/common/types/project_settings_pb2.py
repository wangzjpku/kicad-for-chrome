...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_NETCLASSTYPE']._serialized_start = 1500
    _globals['_NETCLASSTYPE']._serialized_end = 1567
    _globals['_NETCLASSBOARDSETTINGS']._serialized_start = 144
    _globals['_NETCLASSBOARDSETTINGS']._serialized_end = 760
    _globals['_NETCLASSSCHEMATICSETTINGS']._serialized_start = 763
    _globals['_NETCLASSSCHEMATICSETTINGS']._serialized_end = 1062
    _globals['_NETCLASS']._serialized_start = 1065
    _globals['_NETCLASS']._serialized_end = 1359
    _globals['_TEXTVARIABLES']._serialized_start = 1362
    _globals['_TEXTVARIABLES']._serialized_end = 1498
    _globals['_TEXTVARIABLES_VARIABLESENTRY']._serialized_start = 1450
    _globals['_TEXTVARIABLES_VARIABLESENTRY']._serialized_end = 1498